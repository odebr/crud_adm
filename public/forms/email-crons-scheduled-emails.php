...
if($time =='6 am') { $time  = '6:00 am'; }
if($time =='7 am') { $time  = '7:00 am'; }
if($time =='8 am') { $time  = '8:00 am'; }
if($time =='9 am') { $time  = '9:00 am'; }
if($time =='10 am') { $time = '10:00 am'; }
if($time =='11 am') { $time = '11:00 am'; }
if($time =='12 pm') { $time = '12:00 pm'; }
if($time =='1 pm') { $time  = '1:00 pm'; }
if($time =='2 pm') { $time  = '2:00 pm'; }
if($time =='3 pm') { $time  = '3:00 pm'; }
if($time =='4 pm') { $time  = '4:00 pm'; }
if($time =='5 pm') { $time  = '5:00 pm'; }
if($time =='6 pm') { $time  = '6:00 pm'; }

echo $time;


$queryapp = "SELECT * FROM email_create WHERE date='".$date."' AND time = '".$time."' AND sent =''";
...
#frame
	{
		width: 98%;
		background: url($MainLink.'video/uploads/".$GIF."') no-repeat;
		text-align: center;
	}
	.centerer
	{
...
//QUERY LIST    
$querycontacts = "SELECT * FROM contacts WHERE user_id ='".$USERID."' AND email !='' AND list = '".$list."' AND unsubscribe =''";    
...
echo $querycontacts = "SELECT * FROM contacts WHERE user_id ='".$USERID."' AND email !='' AND lead_campaign LIKE '%$lead_campaign%' AND unsubscribe =''"; 
