...
$queryapp = "SELECT * FROM email_create WHERE date='sendnow' AND sent =''";
$query_app = mysqli_query($conn,$queryapp);  
while($app = mysqli_fetch_array($query_app)) { 
    

echo $USERID = $app['user_id'];    
              ...
              <td align="center" valign="top">
                ...
                <table width="640" cellpadding="0" cellspacing="0" border="0" class="container">
                  <tr>
					...
					<div id="frame">
					<span class="play_button"><img src="'.$CRMLink.'forms/images/play.png"/></span>
					</div> 
					</div>
					</a>
                    </td>
...
$domain = "crm.btruleads.com";
   ...
   //$email    = $send_email; 
   //$email_send   = 'neilbetrue@gmail.com, neil@cftnsurprise.com';
   $subjectthre  = $email_subject;
   $fromthre     = $email;    
    
  

$list_tag = str_replace('_', ' ', $list);  
$queryntag = "SELECT * FROM  `user_tags` WHERE user_id = '".$USERID."' AND tag = '".$list_tag."'";
$resntag = mysqli_query($conn,$queryntag);
$rowtag = mysqli_num_rows($resntag); 
...
//QUERY LIST    
echo $querycontacts = "SELECT * FROM contacts WHERE user_id ='".$USERID."' AND email !='' AND list = '".$list."' AND unsubscribe =''";    
         
} 
if($rowtag =='1') {
    
//QUERY CONTACTS WITH TAGS    
$querycontacts = "SELECT * FROM contacts WHERE user_id ='".$USERID."' AND email !='' AND tags LIKE '%$list_tag%' AND unsubscribe =''";    
    
} 
    
if($list =='Lead Forms') { 
//QUERY CONTACTS WITH LEAD FORM CAMPAIGN     
$querycontacts = "SELECT * FROM contacts WHERE user_id ='".$USERID."' AND email !='' AND lead_campaign LIKE '%$lead_campaign%' AND unsubscribe =''"; 
...
$video_css ='';
              ...
              <a href="'.$MainLink.'users/vp.php?user_id='.$USERID.'&video_id='.$video.'">
              <div id="frame">
              <span class="play_button"><img width="630" style="padding:10px;" src="'.$CRMLink.'forms/images/play.png"/></span>
              </div> 
              </a>';
              } 
...
<img style="display: none;" src="'.$CRMLink.'forms/emailtrack.php?image=tracking.gif&user_id='.$USERID.'&email_id='.$EMAILID.'&email='.$EMAIL_SEND.'" alt="Neil Betrue"></td>
                  </tr>
                </table>
                </td>
              </tr>
        ...
        <td align="center" valign="top">
          ...
          <!-- START FOOTER -->
            <table width="640" cellpadding="0" cellspacing="0" border="0" class="wrapper" bgcolor="#FFFFFF">
                ...
                <tr>
                  <td class="content-block" style="background-color: #333333!important;font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;width: 98%;">
